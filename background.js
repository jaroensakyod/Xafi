...
const V6_DEFAULT_PROMPT_TEMPLATE = `หน้าที่ของคุณคือเขียนโพสต์ X ภาษาไทยให้เหมือนคนเล่น X จริง ๆ เขียนเอง จากเนื้อหาต้นทางด้านล่าง
...
const V6_HOT_TAKE_PROMPT_TEMPLATE = `หน้าที่ของคุณคือเขียนโพสต์ X ภาษาไทยให้เหมือนคนเล่น X จริง ๆ เขียนเอง จากเนื้อหาต้นทางด้านล่าง
...
โทนที่ต้องได้:
- ภาษาพูดธรรมชาติ ตรง กระชับ และลื่นแบบคนเล่าให้เพื่อนฟัง
- เลือกเฉพาะประเด็นที่น่าหยิบมาเล่าจริง ๆ ไม่สรุปยืดยาว ไม่เล่าอ้อม
- อ่านแล้วมีน้ำหนักพอให้อยากอ่านต่อหรือแชร์ต่อ แต่ไม่เวอร์ ไม่ประดิษฐ์
- เก็บเฉพาะข้อมูลที่มีอยู่ในต้นทาง ห้ามเดาข้อมูลเพิ่ม

รูปแบบบังคับ:
บรรทัด 1 = ประโยคเปิดสั้น ๆ ที่ชวนให้อยากอ่านต่อทันที
บรรทัด 2 = bullet ข้อแรก ต้องขึ้นต้นด้วย "- "
บรรทัด 3 = bullet ข้อสอง ต้องขึ้นต้นด้วย "- "
บรรทัด 4 = ประโยคปิดสั้น ๆ ที่ทิ้งน้ำหนักหรือโยงกลับประเด็นหลัก
...
กฎที่ต้องทำตามทุกครั้ง:
- ตอบออกมาเป็น 4 บรรทัดที่มีข้อความจริงเท่านั้น ห้ามมีบรรทัดเกินหรือบรรทัดว่าง
- ทุกบรรทัดต้องสั้น กระชับ และอ่านจบได้จริง ห้ามพยายามยืดข้อความให้เต็มเพดาน
- ถ้าเนื้อหาต้นทางมีน้อย ให้เขียนสั้นได้ตราบใดที่ยังครบประเด็นและอ่านลื่น
- ต้องเผื่อพื้นที่ให้ลิงก์สินค้าที่ระบบจะต่อท้ายได้อย่างเป็นธรรมชาติ
- ห้ามมีคำนำประเภท "นี่คือโพสต์" "สรุปให้แล้ว" หรือคำอธิบายใด ๆ
- ห้ามใช้ hashtag, @, ลิงก์, markdown, code block หรือเครื่องหมายอัญประกาศครอบทั้งโพสต์
- เลี่ยงการคัดลอกถ้อยคำจากต้นทางตรง ๆ ถ้าเรียบเรียงใหม่ให้เนียนกว่าได้ ให้เรียบเรียงใหม่
- แต่ละ bullet ต้องมีแค่ประเด็นเดียว และไม่ต้องอัดรายละเอียดเกินจำเป็น
- ถ้าข้อมูลต้นทางบาง ให้เขียนเท่าที่รู้จริง ห้ามเติม fact ใหม่
- ถ้าเนื้อหาต้นทางแรงอยู่แล้ว ให้รักษาน้ำหนักนั้นได้ แต่ห้ามดูเหมือน bait เกินจริง
- หลีกเลี่ยงโทนขายของ โทน PR หรือภาษาที่ดูเหมือนแคปชันโฆษณา
...
โทนที่ต้องได้:
- ภาษาพูดธรรมชาติ ตรง คม และมีน้ำหนักแบบคนมีมุมมองชัด
- เลือกเฉพาะประเด็นที่ชวนคิดหรือชวนถกจริง ๆ ไม่ยืด ไม่อธิบายเกินจำเป็น
- ฟีลแบบโพสต์ X ไทยที่ชวนคิด ชวนเถียงเบา ๆ หรือชวนแชร์ต่อได้ แต่ห้ามเวอร์ ห้ามเฟก
- เก็บเฉพาะข้อมูลที่มีอยู่ในต้นทาง ห้ามเดาข้อมูลเพิ่ม
...
กฎที่ต้องทำตามทุกครั้ง:
- ตอบออกมาเป็น 4 บรรทัดที่มีข้อความจริงเท่านั้น ห้ามมีบรรทัดเกินหรือบรรทัดว่าง
- ทุกบรรทัดต้องสั้น กระชับ และห้ามยืดข้อความให้เต็มเพดานแบบฝืนธรรมชาติ
- ถ้าเนื้อหาต้นทางมีน้อย ให้เขียนสั้นได้ตราบใดที่ยังคม ชัด และไม่เสียประเด็น
- ต้องเผื่อพื้นที่ให้ลิงก์สินค้าที่ระบบจะต่อท้ายได้อย่างเป็นธรรมชาติ
- ห้ามมีคำนำประเภท "นี่คือโพสต์" "สรุปให้แล้ว" หรือคำอธิบายใด ๆ
- ห้ามใช้ hashtag, @, ลิงก์, markdown, code block หรือเครื่องหมายอัญประกาศครอบทั้งโพสต์
- เลี่ยงการคัดลอกถ้อยคำจากต้นทางตรง ๆ ถ้าเรียบเรียงใหม่ให้คมกว่าได้ ให้เรียบเรียงใหม่
...
function normalizeSettings(settings = {}, options = {}) {
    ...
    const canSafelyUpgradePrompt = !currentPrompt
        ...
        || currentPrompt === V6_DEFAULT_PROMPT_TEMPLATE.trim()
        || currentPrompt === V6_HOT_TAKE_PROMPT_TEMPLATE.trim()
...
function isBuiltInPromptTemplate(template) {
    ...
    return normalized === LEGACY_DEFAULT_PROMPT_TEMPLATE.trim()
        ...
        || normalized === V6_DEFAULT_PROMPT_TEMPLATE.trim()
        || normalized === V6_HOT_TAKE_PROMPT_TEMPLATE.trim()
